...
function InterestRateCard({ assets, selectedAsset, onSelectAsset }) {
  ...
  return (
    <div className="macro-card">
      <div className="card-header">
        <h3 className="card-title">Interest Rate</h3>
                ...
                {chartType === "line" ? (
                  ...
                  >
                    ...
                    <YAxis 
                      ...
                      tickFormatter={(val) => val >= 1000000 ? (val / 1000000).toFixed(1) + 'M' : val >= 1000 ? (val / 1000).toFixed(1) + 'k' : val.toFixed(1)}
                    />
                    <Tooltip content={<CandlestickTooltip suffix="%" />} cursor={{ fill: "rgba(255, 255, 255, 0.03)" }} />
                    <Bar
                      dataKey="range"
